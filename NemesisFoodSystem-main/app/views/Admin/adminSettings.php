         ...
         <div class="container">
            <div class="row">
                <div class="col-12 d-flex flex-row" style="margin-top: 5%;">
                    <button class="btn btn-outline-light" style="width: 76%; margin-left: 15%; margin-top: 10%;" onclick="printPage('/Main/PrintView');">Print all data from the database</button>
                </div>
            </div>
        </div>
